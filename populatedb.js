...
async function createItems() {
  ...
  await Promise.all([
    itemCreate("Resident Evil 4", "The Original Survival Horror's most action-packed entry yet, are you a bad enough dude to rescue the President's daughter in this thrilling action-horror classic?", 
    ...
    itemCreate("Morrowind: GOTY Edition", "The critically-acclaimed sequel to Arena and Daggerfall, enter the alien land of Morrowind and decide it's fate in this expansive, atmospheric masterpiece.", 
    ...
    itemCreate("God Hand", "The funnest, campiest beat-em-up action game available. You're not Alexander, or are you?", "Used", "6", genres[1]._id, "Capcom", "PS2", 2006),
    itemCreate("Super Mario Bros 3", "Play as Mario as he stomps turts throughout the Mushroom Kingdom. Perchance.", "New", "2", genres[3]._id, "Nintendo", "NES", 1988),
    ...
    itemCreate("Thief: The Dark Project", "You play as Garrett, a cynical master thief who has become embroiled in a series of events of epic proportions.", 
